[instagram-private-api](../../README.md) / [errors](../../modules/errors.md) / IgNotFoundError

# Class: IgNotFoundError

[errors](../../modules/errors.md).IgNotFoundError
...
- [constructor](IgNotFoundError.md#constructor)

### Properties

- [message](IgNotFoundError.md#message)
- [name](IgNotFoundError.md#name)
- [response](IgNotFoundError.md#response)
- [stack](IgNotFoundError.md#stack)
- [text](IgNotFoundError.md#text)
- [stackTraceLimit](IgNotFoundError.md#stacktracelimit)

### Methods

- [captureStackTrace](IgNotFoundError.md#capturestacktrace)
- [prepareStackTrace](IgNotFoundError.md#preparestacktrace)
