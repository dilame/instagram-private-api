[instagram-private-api](../../README.md) / [errors](../../modules/errors.md) / IgInactiveUserError

# Class: IgInactiveUserError

[errors](../../modules/errors.md).IgInactiveUserError
...
- [constructor](IgInactiveUserError.md#constructor)

### Properties

- [message](IgInactiveUserError.md#message)
- [name](IgInactiveUserError.md#name)
- [response](IgInactiveUserError.md#response)
- [stack](IgInactiveUserError.md#stack)
- [text](IgInactiveUserError.md#text)
- [stackTraceLimit](IgInactiveUserError.md#stacktracelimit)

### Methods

- [captureStackTrace](IgInactiveUserError.md#capturestacktrace)
- [prepareStackTrace](IgInactiveUserError.md#preparestacktrace)

## Constructors

### constructor

• **new IgInactiveUserError**(`response`)
