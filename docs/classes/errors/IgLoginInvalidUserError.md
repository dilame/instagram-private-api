[instagram-private-api](../../README.md) / [errors](../../modules/errors.md) / IgLoginInvalidUserError

# Class: IgLoginInvalidUserError

[errors](../../modules/errors.md).IgLoginInvalidUserError
...
- [constructor](IgLoginInvalidUserError.md#constructor)

### Properties

- [message](IgLoginInvalidUserError.md#message)
- [name](IgLoginInvalidUserError.md#name)
- [response](IgLoginInvalidUserError.md#response)
- [stack](IgLoginInvalidUserError.md#stack)
- [text](IgLoginInvalidUserError.md#text)
- [stackTraceLimit](IgLoginInvalidUserError.md#stacktracelimit)

### Methods

- [captureStackTrace](IgLoginInvalidUserError.md#capturestacktrace)
- [prepareStackTrace](IgLoginInvalidUserError.md#preparestacktrace)

## Constructors

### constructor

• **new IgLoginInvalidUserError**(`response`)
