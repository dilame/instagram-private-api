...
- [Feed](_core_feed_.feed.md)‹_[UserFeedResponse](../interfaces/\_responses_user_feed_response_.userfeedresponse.md)_, _[UserFeedResponseItemsItem](../interfaces/_responses_user_feed_response_.userfeedresponseitemsitem.md)\_›
...
\+ **new UserFeed**(`client`: [IgApiClient](_core_client_.igapiclient.md)): _[UserFeed](\_feeds_user_feed_.userfeed.md)\_
...
_Defined in [feeds/user.feed.ts:6](https://github.com/realinstadude/instagram-private-api/blob/4ae8fec/src/feeds/user.feed.ts#L6)_
...
_Defined in [feeds/user.feed.ts:26](https://github.com/realinstadude/instagram-private-api/blob/4ae8fec/src/feeds/user.feed.ts#L26)_
...
_Defined in [feeds/user.feed.ts:15](https://github.com/realinstadude/instagram-private-api/blob/4ae8fec/src/feeds/user.feed.ts#L15)_
