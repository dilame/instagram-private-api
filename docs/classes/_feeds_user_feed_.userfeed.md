...
*Defined in [feeds/user.feed.ts:6](https://github.com/dilame/instagram-private-api/blob/01eb399/src/feeds/user.feed.ts#L6)*
...
*Defined in [feeds/user.feed.ts:26](https://github.com/dilame/instagram-private-api/blob/01eb399/src/feeds/user.feed.ts#L26)*
...
*Defined in [feeds/user.feed.ts:15](https://github.com/dilame/instagram-private-api/blob/01eb399/src/feeds/user.feed.ts#L15)*
