[instagram-private-api](../../README.md) / [sticker-builder](../../modules/sticker_builder.md) / AttachmentSticker
...
▸ **left**(): [`AttachmentSticker`](AttachmentSticker.md)
...
▸ **scale**(`factor`): [`AttachmentSticker`](AttachmentSticker.md)
