...
- [Feed](_core_feed_.feed.md)‹_[UsertagsFeedResponseRootObject](../interfaces/\_responses_usertags_feed_response_.usertagsfeedresponserootobject.md)_, _[UsertagsFeedResponseItemsItem](../interfaces/_responses_usertags_feed_response_.usertagsfeedresponseitemsitem.md)\_›
...
\+ **new UsertagsFeed**(`client`: [IgApiClient](_core_client_.igapiclient.md)): _[UsertagsFeed](\_feeds_usertags_feed_.usertagsfeed.md)\_
...
_Defined in [feeds/usertags.feed.ts:6](https://github.com/realinstadude/instagram-private-api/blob/4ae8fec/src/feeds/usertags.feed.ts#L6)_
...
_Defined in [feeds/usertags.feed.ts:26](https://github.com/realinstadude/instagram-private-api/blob/4ae8fec/src/feeds/usertags.feed.ts#L26)_
...
_Defined in [feeds/usertags.feed.ts:15](https://github.com/realinstadude/instagram-private-api/blob/4ae8fec/src/feeds/usertags.feed.ts#L15)_
