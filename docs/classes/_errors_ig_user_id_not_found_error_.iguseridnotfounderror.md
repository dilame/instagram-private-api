...
*Defined in [errors/ig-user-id-not-found.error.ts:3](https://github.com/dilame/instagram-private-api/blob/e9c516c/src/errors/ig-user-id-not-found.error.ts#L3)*
