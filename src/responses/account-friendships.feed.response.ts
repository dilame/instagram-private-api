...
export interface BestFriendshipsFeedResponse {
  sections: null;
  users: BestFriendshipsFeedResponseUsersItem[];
  big_list: boolean;
  next_max_id: null;
  page_size: number;
  status: string;
}
export class BestFriendshipsFeedResponseUsersItem extends ProfileEntity {
  pk: number;
  username: string;
  full_name: string;
  is_private: boolean;
