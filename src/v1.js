...
InstagramV1.Feed.SelfLiked = require('./v1/feeds/self-liked.feed').SelfLikedFeed;
InstagramV1.Feed.MediaComments = require('./v1/feeds/media-comments.feed').MediaCommentsFeed;
InstagramV1.Feed.SavedMedia = require('./v1/feeds/saved-media.feed').SavedMediaFeed;
